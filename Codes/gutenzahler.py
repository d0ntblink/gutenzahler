...
Arguments:
    ...
    --stem: generates a stem graph of the alphabet letters
...
Example:
    gutenzahler.py --fetch 10010 --stem
...
while True:
    ...
    for letter, count in alphabet_dict.items():
        print("%s is repeated %i times and makes up %2.4f%% of the all the letters." % (letter, count, ((count/total_num_letters)*100)))
